 ...
 * 
 * 
 * @author http://blog.csdn.net/xiaokui_wingfly/article/details/41744887
 * 
 */
 ...
 public class ImgController {
	  ...
	  * @throws IOException
	  */
	 @RequestMapping(value ="/createImg.action",method =RequestMethod.GET)
     public void createImg(HttpServletRequest request,HttpServletResponse response,String id) throws IOException{
	 ...
	 @RequestMapping(value ="/validateImg.action",method =RequestMethod.POST)
     public void validateImg(HttpServletRequest request,HttpServletResponse response,String id) throws IOException{
		 String check = (String)request.getSession().getAttribute("checkcode");
         String inputCode = request.getParameter("inputCode");
         response.setContentType("text/plain");//response.setHeader("Content-Type", "image/jpeg");
         response.setDateHeader("expries", -1);
         response.setHeader("Cache-Control", "no-cache");
         response.setHeader("Pragma", "no-cache");
         if(inputCode.toLowerCase().equals(check.toLowerCase())){
